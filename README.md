...
class TrainSeederFaker extends Seeder
{
    /**
    ...
    {   
        ...
        for($i=0; $i<100; $i++){
            ...
            $newTrainFaker = new Train();
            $newTrainFaker->azienda = $faker->words();
            $newTrainFaker->stazione_di_partenza = $faker->words();
            $newTrainFaker->stazione_di_arrivo = $faker->words();;
            ...
            $newTrainFaker->numero_carrozze = $faker->numberBetween(0, 10);
